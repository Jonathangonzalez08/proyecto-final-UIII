...
$sql="SELECT * FROM jefechofer WHERE idjefe='$idjefe'";
    ...
    <body>
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                                ...
                                <input type="hidden" name="idjefe" value="<?php echo $row['idjefe']  ?>"> 
                                ...
                                <input type="text" class="form-control mb-3" name="matricula" placeholder="Matricula del auto" value="<?php echo $row['matricula']  ?>">
